...
¿Qué opciones tenemos para desplegar una app? Principalmente:

--

- [Posit Connect](https://posit.co/products/enterprise/connect/): empresarial

--

- [Shiny Server](https://posit.co/download/shiny-server/): open source

--

- [shinyapps.io](https://www.shinyapps.io/) / [Posit Cloud](https://connect.posit.cloud/): planes para profesionales con opción gratuita
